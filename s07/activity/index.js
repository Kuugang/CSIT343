...
function getArtistsArray(){
    let artists = ["Cup of Joe", "Keshi", "The 1976", "New Jeans", "Twice"];
    console.log(artists); 
}
...
function getSongsArray(){
    let songs = ["Bubble Gum", "Multo", "Dream", "Oh Caroline", "Fancy"];
    console.log(songs);
}
...
function getMoviesArray(){
    let movies = ["All Quiet on the Western Front", "Hacksaw Ridge", "Stalingrad", "Oppenheimer", "Outlaw King"];
    console.log(movies);
}
getMoviesArray()
